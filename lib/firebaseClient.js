...
export async function requestNotificationPermission() {
  try {
    ...
    if (!supported || typeof window === "undefined" || !("serviceWorker" in navigator)) return null;
    ...
    // Firebase requires the service worker to be active before requesting a token.
    // Waiting for navigator.serviceWorker.ready avoids the common "no active Service Worker" crash.
